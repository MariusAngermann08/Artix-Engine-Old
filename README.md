# Artix Engine - 2D Python Game Engine
...
3. Run the following command to install the required Python dependencies: ```pip install pygame tkinter customtkinter pymunk pillow```
