...
player.attributes.attributes.append(player.attributes.PhysicsObject(player,position=(50,0),static=False, own_size=(300,300), space_path=new_scene.space))
...
floor.attributes.attributes.append(floor.attributes.PhysicsObject(floor,position=(10,600), static=True, own_size=(640,100), space_path=new_scene.space))
floor.attributes.attribute_names.append("PhysicsObject")



#events
player.eventsystem.root_node.append(player.eventsystem.Event(player, new_scene, "collision","floor"))
player.eventsystem.root_node[0].actions.append(player.eventsystem.Action(player, "set_position", "50", "50"))
